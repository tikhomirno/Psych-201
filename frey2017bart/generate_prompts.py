...
for folder in folders:
    ...
    for participant_id in bart_pumps["partid"].unique():
        ...
        session_text = (
            "Your goal is to maximize points by inflating the balloon without making it explode.\n"
            "Participants must decide at each step whether to continue inflating the balloon to earn more money\n"
            "or to stop and bank the money accumulated so far. If they choose to stop inflating, the money earned\n"
            "is added to their permanent total, and a new balloon appears on the screen.\n\n"
            + "\n\n".join(trials_text)
        )
